...
public class search extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        List<String> CountysList = new ArrayList<>(Arrays.asList(County));

        // Initializing an ArrayAdapter
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this,R.layout.activity_search_spinner,CountysList){
            @Override
        ...
        adapter1.setDropDownViewResource(R.layout.activity_search_spinner);
